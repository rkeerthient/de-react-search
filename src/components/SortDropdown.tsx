  ...
  return (
    <div className="relative text-sm ml-auto">
      <Menu as="div" className="relative inline-block text-left">
        <MenuButton className="inline-flex w-56 justify-between gap-x-1.5 rounded-md bg-white px-3 py-2 text-sm  text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50">
        ...
        <MenuItems
          transition
          className="absolute right-0 z-10 w-56 origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 transition-all ease-out duration-200"
        >
          <div className="py-1">
            {sortOptions
              ...
              .map((s) => (
                ...
                >
                  {({ active }) => (
                    <div
                      className={`flex h-10 w-56 items-center px-2 ${
